...
/**
 * Converts a PHP array to HTML option tags,
 * returning them as a string
 * 
 * This function returns a string of HTML option
 * tags, using $options elements as text and
 * adding a value attribute if $keysAsValues
 * is true.
 * 
 * @param mixed[] $options Its elements are used as HTML option tag text and their keys as value attributes
...
function makeOptions($options, $keysAsValues = false) {
	...
	return '<option>' . implode('</option><option>', $options) . '</option>';
}
